        ...
        <div className={styled.main}>
          ...
          <form>
            <fieldset>
              ...
              <input onBlur={inputUserBlur} ref={usernameRef} className={styled.input} type="text"/>
            </fieldset>
            <fieldset>
              <label>Password</label>
              <input  ref={passworldRef}  className={styled.input} type="password"/>
            </fieldset>
            {
              signType === 'signUp' ? 
              (
                ...
                <fieldset>
                  <label>Password</label>
                  <input ref={passworldAgainRef} className={styled.input} type="password"/>
                </fieldset>
                <fieldset className={styled.agreeBox}>
                  <input id="user_agree_to_terms" type="checkbox"/>
                  <label htmlFor="user_agree_to_terms">Creating an account means you’re okay with me</label>
                </fieldset>
                </>
              ) : ''
            }
            <input 
              onClick={handleLoginOrUp} 
